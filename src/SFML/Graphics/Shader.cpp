...
////////////////////////////////////////////////////////////
bool Shader::LoadFromFile(const std::string& filename_VS, const std::string& filename_PS)
{
        // - VERTEX SHADER
    {
...
////////////////////////////////////////////////////////////
bool Shader::LoadFromMemory(const std::string& shader_VS, const std::string& shader_PS)
{
    // Save shaders codes
...
bool Shader::CompileProgram()
{
    ...
    const char* vertexSrc = myVertexShader.empty() ? vertexSrc_static : myVertexShader.c_str();
