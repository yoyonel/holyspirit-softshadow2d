...
////////////////////////////////////////////////////////////
bool RenderImage::Create(unsigned int width, unsigned int height, bool depthBuffer, bool stencilBuffer)
{
    std::cout<<"RenderImage::Create"<<std::endl;
    ...
    */
    ...
    if (!myRenderImage->Create(width, height, myImage.myTexture, depthBuffer, stencilBuffer))
        return false;
