...
void Directional_light::Generate(std::vector<Wall> &m_wall)
{
    ...
    AddTriangle(sf::Vector2f((m_influence_radius*cos(angle + o_angle * 0.5))
                            ,(m_influence_radius*sin(angle + o_angle * 0.5))) ,
                sf::Vector2f((m_influence_radius*cos(angle - o_angle * 0.5))
                            ,(m_influence_radius*sin(angle - o_angle * 0.5))),0,m_wall);
}
