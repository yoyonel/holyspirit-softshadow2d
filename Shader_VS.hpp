...
#ifndef SFML_SHADER_VS_HPP
#define SFML_SHADER_VS_HPP
...
///
////////////////////////////////////////////////////////////
class SFML_API Shader_VS : public Shader
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    Shader_VS(const Shader_VS& copy);
    Shader_VS(const Shader& copy);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the shader from a files
    ///
    /// The sources must be a text file containing a valid
    /// vertex/fragment shader in GLSL language.
    ///
    /// \param filename_VS Path of the vertex shader file to load
    /// \param filename_PS Path of the vertex shader file to load
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool LoadFromFile(const std::string& filename_VS, const std::string& filename_PS);

    ////////////////////////////////////////////////////////////
    /// \brief Load the shader from a source code in memory
    ///
    /// The sources code must be a valid vertex/fragment shader in
    /// GLSL language.
    ///
    /// \param shader_VS String containing the source code of the shader (Vertex Shader)
    /// \param shader_PS String containing the source code of the shader (Pixel Shader)
    ///
    /// \return True if loading succeeded, false if it failed
    ///
    /// \see LoadFromFile
    ///
    ////////////////////////////////////////////////////////////
    bool LoadFromMemory(const std::string& shader_VS, const std::string& shader_PS);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Shader_VS& operator =(const Shader_VS& right);
    Shader getShader();
////////////////////////////////////////////////////////////
...
private :
    ...
    std::string  myVertexShader;   ///< Fragment shader source code
};
...
/// that you can set from your C++ application. sf::Shader_VS
...
/// with either Shader_VS::SetParameter or Shader_VS::SetTexture:
/// \code
/// shader.SetParameter("offset", 2.f);
/// shader.SetParameter("color", 0.5f, 0.8f, 0.3f);
/// shader.SetTexture("image", image); // image is a sf::Image
/// shader.SetTexture("current", sf::Shader_VS::CurrentTexture);
/// \endcode
///
/// Shader_VS::CurrentTexture is a special value that represents
...
/// \endcode
///
/// Shader_VSs can be used on any drawable, but they are mainly
...
/// any texture.
///
/// Shader_VSs can also be used to apply global post-effects to the
...
/// sf::Shader_VS can also be used directly as a raw fragment
