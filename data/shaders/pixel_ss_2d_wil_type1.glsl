...
// E0, I0, I1, E1 = INSIDE_CIRCLE, INSIDE_CIRCLE, ON_CIRCLE, OUTSIDE_CIRCLE
float compute_shadow_light(in vec2 P)
{
    vec2 E0 = u_v_e0;
    vec2 E1 = u_v_e1;
    ...
    vis_light -= 1 - compute_visibility_light_in_on(P, I0, I1, r);
    vis_light -= 1 - compute_visibility_light_out_on(P, E1, I1, r);
