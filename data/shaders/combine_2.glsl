...
#define USE_ATTENUATION     // Utilise un coefficient d'attenuation lie ÃÂ  la distance du centre de la lumiere
#define USE_COLOR           // Utilise la couleur de la lumiere
//#define USE_HARDSHADOW    // Affiche les volumes d'ombres dures (pas tout a fait equivalent ÃÂ  une source ponctuelle de lumiere (en terme de visibilite))
...
void main()
{
    ...
    float compute_normal_map( in vec3 P, in vec3 Light, in vec2 tex_coords_nm )
    {
        ...
        // Scale le lighting lie ÃÂ  la normal map
        // revient ÃÂ  modifier la courbe de la pente (et sa valeur min)
        float nm_scale = +0.45;
