...
// Remap penumbra coefficient for the outer-penumbra: [0, 1] -> [0.5, 1]
#define REMAP_PENUMBRA(coef_penumbra)   (((coef_penumbra)/2) + 0.5)
...
//    float coef_penumbra_rp = compute_penumbra_rp(v_pos_in_ls, v_intersections[0], u_v_intersection_normal);
...
//    coef_penumbra = abs(coef_penumbra_wd - coef_penumbra_rp)*10; // difference entre les methodes (normalement il ne devrait pas en avoir ...)
    ...
    gl_FragColor = vec4(0, 0, coef_penumbra, 1);
}
