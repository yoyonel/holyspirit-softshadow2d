...
// E0, I0, I1, E1 = OUTSIDE_CIRCLE, ON_CIRCLE, ON_CIRCLE, OUTSIDE_CIRCLE
float compute_shadow_light(in vec2 P)
{
    vec2 E0 = u_v_e0;
    vec2 E1 = u_v_e1;
    ...
    //
    float vis_light = 1.;
    vis_light -= 1 - compute_visibility_light_out_out(P, E0, I0, I1, E1, r);
...
float   compute_visibility_light_on_on(in vec2 P, in vec2 E0, in vec2 E1, in float r)
{
    ...
    float inv_area_light = 1.f/(M_PI*r*r);
    float inv_r = 1./r;
