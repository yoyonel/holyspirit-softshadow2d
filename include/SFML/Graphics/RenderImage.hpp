...
public :
    ...
    /// The parameter, \a depthBuffer, is useful if you want
    /// to use the render-image for 3D OpenGL rendering that requires
    /// a depth-buffer. Otherwise it is unnecessary, and you should
    /// leave this parameter to false (which is its default value).
    /// The parameter, \a stencilBuffer, is useful if you want
    /// to use the render-image for 3D OpenGL rendering that requires
    /// a stencil-buffer. Otherwise it is unnecessary, and you should
    /// leave this parameter to false (which is its default value).
    ///
